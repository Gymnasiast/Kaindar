...
?>
    <table class="geenlijnen">
        <tr>
            <td class="geenlijnen">Code:</td>
            <td class="geenlijnen"><input type="text" maxlength="10" size="10" name="code"/></td>
        </tr>
        <tr>
            <td class="geenlijnen">Dag:</td>
            <td class="geenlijnen"><input type="text" maxlength="2" size="2" name="dag"/></td>
        </tr>
        <tr>
            <td class="geenlijnen">Maand:</td>
            <td class="geenlijnen"><input type="text" maxlength="2" size="2" name="maand"/></td>
        </tr>
        <tr>
            <td class="geenlijnen">Jaar:</td>
            <td class="geenlijnen"><input type="text" maxlength="4" size="4" name="jaar" value="<?php echo $jaar ?>"/>
            </td>
        </tr>
        <tr>
            <td class="geenlijnen">Commentaar:</td>
            <td class="geenlijnen"><input type="text" maxlength="100" name="commentaar"/></td>
        </tr>
        <tr>
            <td class="geenlijnen">Bij:</td>
            <td class="geenlijnen"><input type="text" name="bij"/></td>
        </tr>
        <tr>
            <td class="geenlijnen">Af:</td>
            <td class="geenlijnen"><input type="text" name="af"/></td>
        </tr>
        <tr>
            <td class="geenlijnen">Betaalde/ontvangen BTW (i.v.t.):</td>
            <td class="geenlijnen"><input type="text" name="btw"/></td>
        </tr>
        <tr>
            <td colspan="100%" class="geenlijnen"><input type="submit" value="Invoeren"></td>
        </tr>
    </table>
    </form>
    <table class="geenlijnen">
        <tr>
            <td class="geenlijnen"><br/>Huidig saldo: &euro;
                <?php
    ...
    <table class="table table-bordered">
        ...
        while (list($id, $code, $omschrijving, $datumobs, $datum, $commentaar, $bij, $af, $btw) = mysql_fetch_row($mutaties))
        {
            ...
            echo "</td><td><a href=\"/bewerkmutatie?actie=bewerken&id=$id\"><img src=\"afb/bewerken.png\" alt=\"Bewerk deze mutatie\" /></a></td>
		<td><a href=\"/bewerkmutatie?actie=verwijderen&id=$id\"><img src=\"afb/verwijderen.png\" alt=\"Verwijder deze mutatie\" /></a></td>
		</tr>";
        }
        ?>
    </table>
